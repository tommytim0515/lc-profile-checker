...
def acquire_user_profile(username: str) -> Optional[Dict[str, Any]]:
    ...
    r = s.post(API_URL+POSTFIX_GRAPHQL, cookies=s.cookies,
...
def get_user_solved_problem_count(user_profile: Optional[Dict[str, Any]]) -> int:
    if user_profile is None:
        return 0
    accepted_submission_nums = user_profile['data']['matchedUser']['submitStats']['acSubmissionNum']
